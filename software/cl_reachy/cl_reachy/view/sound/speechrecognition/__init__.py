    ...
    for response in responses:
        ...
        if result.is_final:
            ...
            if callback is not None:
                callback(corrected_time, transcript)
...
class SpeechRecognition(object):
    def __init__(self):
        ...
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = os.path.join(self.resources, "reachySTT.json")
    ...
    def start(self, heard_callback=None, final_callback=None):
        ...
        with self.mic_manager as stream:
            while not stream.closed:
                ...
                listen_print_loop(responses, stream, heard_callback)
